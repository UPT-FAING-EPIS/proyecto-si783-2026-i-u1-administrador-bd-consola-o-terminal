...
class REPL:
 ...
 |____/|____/   \____|_____|___|
        ...
        rprint("[bold green]Escribe [white]'help'[/white] para ver los comandos o [white]'exit'[/white] para salir.[/bold green]\n")
    ...
    def _help(self):
        ...
        help_text.append("\nOTROS:\n", style="bold yellow")
        help_text.append("  export <archivo.csv>                        - Exportar último SELECT a CSV\n")
